...
const Button = ({
  ...
  return (
    <>
      <button
        onClick={() => onClick()}
        className="group h-8 mt-2 w-24 md:w-32 px-4 border-lensDark border-2 relative text-lensDark ring-lensDark hover:bg-rose-400 focus:ring-offset-1 focus:ring-2"
      >
