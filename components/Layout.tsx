...
const Layout = ({ children, meta }: LayoutProps) => {
  return (
    <>
      ...
      <div className="bg-gradient-to-br from-lens via-purple-100 to-green-100 relative w-full h-screen to-indigo-400 flex flex-col items-center md:justify-center">
        {children}
        <Footer></Footer>
      </div>
    </>
